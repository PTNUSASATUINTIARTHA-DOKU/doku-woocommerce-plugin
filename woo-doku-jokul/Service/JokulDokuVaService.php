...
class JokulDokuVaService
{
    ...
    public function generated($config, $params)
    {
        ...
        $this->jokulUtils->doku_log($this, 'DOKUVA REQUEST : ' . json_encode($data), $params['invoiceNumber']);
        $this->jokulUtils->doku_log($this, 'DOKUVA REQUEST URL : ' . $url, $params['invoiceNumber']);
        $this->jokulUtils->doku_log($this, 'DOKUVA RESPONSE : ' . json_encode($responseJson, JSON_PRETTY_PRINT), $params['invoiceNumber']);
