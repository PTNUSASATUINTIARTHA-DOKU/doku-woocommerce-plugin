...
class JokulBsmVaService
{
    ...
    public function generated($config, $params)
    {
        ...
        $this->jokulUtils->doku_log($this, 'BSM REQUEST : ' . json_encode($data), $params['invoiceNumber']);
        $this->jokulUtils->doku_log($this, 'BSM REQUEST URL : ' . $url, $params['invoiceNumber']);
        $this->jokulUtils->doku_log($this, 'BSM RESPONSE : ' . json_encode($responseJson, JSON_PRETTY_PRINT), $params['invoiceNumber']);
