...
class JokulBriVaService
{
    ...
    public function generated($config, $params)
    {
        ...
        $this->jokulUtils->doku_log($this, 'BRI REQUEST : ' . json_encode($data), $params['invoiceNumber']);
        $this->jokulUtils->doku_log($this, 'BRI REQUEST URL : ' . $url, $params['invoiceNumber']);
        $this->jokulUtils->doku_log($this, 'BRI RESPONSE : ' . json_encode($responseJson, JSON_PRETTY_PRINT), $params['invoiceNumber']);
